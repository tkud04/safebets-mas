                ...
                <div class="row">
                    <div class="col-md-12 text-center">
						...
						<form>
						 ...
						 <div id="working"></div>
                        <a rel="nofollow" href="#" class="wow animated fadeInUp btn btn-common btn-lg mt-50 meke-btn" data-wow-delay=".6s"><i class="fa fa-check-square"></i> <strong>YES! SUBSCRIBE ME NOW!</strong><div class="ripple-container"></div></a>
                    </div>
                </div>
            </div>
        </section>
