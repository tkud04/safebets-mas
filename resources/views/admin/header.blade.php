                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <i class="fa fa-user fa-3x"></i> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <i class="fa fa-user fa-3x"></i> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <i class="fa fa-user fa-3x"></i> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
