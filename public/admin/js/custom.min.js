$(function() {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
	  ...
	  else getCompetitions(u,l);
  });
});



function getCompetitions(url,id){
	$.ajax({   
   type : 'GET',
   url  : url,
   data : {'xid':id},
   ...
   success :  function(response)
      {         
	   ...
	   if(response == "404"){}
		     ...
		     $('#competitions').html("<option value='none'>Select competition</option>");
		     rr = JSON.parse(response);
			 if(rr['status'] == "success"){
				 var comps = rr['competitions'];
		        $.each(comps,function(i,v){
			       obj = v;
			       $('#competitions').append("<option value='" + obj['id'] + "'>" + obj['name'] + "</option>");
		        });		  
	         } 
	      }			 
     }
